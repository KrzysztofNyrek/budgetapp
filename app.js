...
var budgetController = (function(){
  ...
  return{
    ...
    calculateBudget: function(){
      ...
      //calculate the percentage of income thath we spend
      if(data.total.inc > 0){
...
var UIController = (function(){
  ...
  //Formating number in budget items
  ...
  return {
    ...
    clearFields: function(){
      ...
      fieldsArr = Array.prototype.slice.call(fields); //allow get back array from list
      //loops for all array elements and set them empty
